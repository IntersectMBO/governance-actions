...
The expanded booth and mainstage presence will also amplify the visibility of Cardano ecosystem projects showcasing at the event, providing them with exposure to a broader and more prominent audience.

**Important Notes:** Regarding the vote for this “Cardano at TOKEN2049 Singapore 2026: Top-Up ‘Title’ Sponsorship Upgrade (Modular Extension)”, please vote **"YES"** only if you support the "Cardano at TOKEN2049 Singapore 2026: Baseline ‘Platinum’ Sponsorship Proposal" as a DRep and wish to upgrade it to a ‘Title’ Sponsorship.
...
The primary objective of this top-up upgrade is to convert premium visibility, specifically the mainstage keynote and media introductions, into measurable ecosystem growth, strategic partnerships, and institutional relationships.

## Rationale

### The Value of the ‘Title’ Upgrade

The case for upgrading to the ‘Title’ Sponsorship at TOKEN2049 rests on the unique value of the mainstage keynote and guaranteed media exposure. While the ‘Platinum’ tier provides excellent lead generation and networking opportunities, the ‘Title’ tier provides thought leadership dominance.

The additional **$424,360** USD total requested budget specifically unlocks:

* **144sqm large booth activation:** A larger booth activation compared to the ‘Platinum’ sponsorship which was 108sqm  
* **15-Minute Mainstage Keynote:** A guaranteed speaking slot on the primary stage, allowing Cardano to deliver its core narrative directly to the largest possible audience.  
* **Mention in Event Press Release:** Official inclusion in TOKEN2049's global PR distribution, ensuring visibility in top-tier financial and crypto media before the event begins.  
* **Introductions to Media:** Direct, facilitated introductions to key journalists and reporters covering the event.  
* **Event-Wide Branding & Engagement:** Branded lanyards worn by attendees throughout the event, and a dedicated protein shake station, providing continuous visibility and repeated engagement with attendees.  
* **Additional Access:** 2x Invites to the exclusive Speakers Reception, 5x additional invites to AFTER 2049, and 5x additional general event tickets.

### Strategic Importance of Singapore

Singapore occupies a unique position as both a regulated financial center and a leading hub for digital asset innovation. With the Singapore edition serving as TOKEN2049’s flagship event in 2026, and demand concentrated following the cancellation of Dubai, the event provides a uniquely efficient channel to engage the audiences that matter most for Cardano’s next phase of growth.

### Cardano Vision 2030 Alignment

#### Core KPIs

By securing the mainstage keynote, Cardano's presence is elevated before 25,000+ attendees, including institutional investors, enterprise decision-makers, and Web3 builders. The keynote creates a direct pipeline for new ecosystem participants at scale. The wallet sign-up targets, lead generation, and partnership initiations in this proposal are designed to convert event engagement into measurable on-chain activity, supporting the 2030 targets of 1M MAU and ≥ 27M monthly transactions.

#### Pillar 2: Adoption & Utility

The mainstage keynote directly amplifies the reach of the high-value verticals identified in the strategy, DeFi, RWA, payments, and enterprise applications, by positioning Cardano's institutional-grade infrastructure before the largest possible audience in Asia's premier financial hub.

#### Pillar 4: Community & Ecosystem Growth

This upgrade executes directly on the strategy's call for localized adoption and global market engagement. The keynote, combined with facilitated media introductions and post-event content distribution, ensures impact extends well beyond the event itself.

### Sponsorship Tier Comparison

The following table highlights the specific benefits unlocked by this top-up proposal.
...
| Searchable Attendee List via the App | YES | Already Included |
| Lead Scanning | YES | Already Included |
| Logo displayed on Signages Across the Venue | YES | Already Included |
| Featured in TOKEN2049 App and Website | YES | Already Included |

### Event Program

#### Day 1: October 7, 2026: Unified Community Day & Mainstage Keynote

The first day will focus on visibility and reach. If this upgrade is approved, the 15-minute mainstage keynote will be delivered, setting the tone for Cardano's presence. The flagship booth will host live product demonstrations from leading Cardano ecosystem builders, supported by a dedicated presentation area.
...
| User Acquisition | Cardano Wallet sign-ups | 200 | 260 |
| Education | Cardano Academy subscribers | 200 | 260 |
| Media Impact | Media coverage, features, and published interviews | 20 major media outlets | 26 major media outlets |
| Media Reach | Guaranteed press release inclusions | None | 1 |
| Media Engagement | Facilitated media introductions and meetings | None | 5 major outlets |
| Executive Networking | Speakers Reception engagements | Tracked & reported | Tracked & reported |

### Budget Breakdown

The total requested budget for this top-up proposal is $424,360 USD (1,768,167 ada).  The budget below represents only the **price delta** between ‘Platinum’ (Baseline) and ‘Title’ (Top-Up) tiers. To maintain fiscal discipline, no additional management fees are added to this top-up proposal; the management of this tier is covered by the existing Baseline Proposal operational fee.

**EMURGO is acting as the fiscal and operational conduit for this event. As such, these funds are treated as a direct pass-through expenditure, with 100% of the top-up capital applied to the vendor-mandated costs of the ‘Title’ Sponsorship upgrade.**
...
| ----- | :---- | :---- |
| Top-Up ‘Title’ Sponsorship Upgrade | Direct payment to TOKEN2049 covering the additional benefits including a mainstage keynote, press release inclusion, media introductions, expanded branding (lanyards), a high-traffic engagement point (protein shake station), a larger booth footprint (144 sqm), and additional access, along with all associated benefits outlined in the proposal. | $300,000 |
| Booth Build/ Logistics to third-party vendor | Extra cost needed for a larger booth and stage setup | $100,000 |
| Compliance & Governance | 3% allocation for legal review, audit provisions, and tax compliance. | $12,000 |
| **Total Budget** |  | **$412,000** |
| **Intersect’s 3% admin fee** |  | **$12,360** |
| **Total Request** |  | **$424,360** |
...
| :---- | :---- | :---- | :---- |
| Milestone 1 | 1,768,167 ada | $424,360 | Available immediately upon DRep approval (contingent on Baseline proposal approval). Enables EMURGO to secure the ‘Title’ upgrade with TOKEN2049. |

#### Audits

This proposal includes a provision for the cost of an independent audit, allocated within category Compliance & Governance in the budget breakdown.
