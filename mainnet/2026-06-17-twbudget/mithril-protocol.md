...
Teragone has not previously received direct funding from Cardano treasury or community governance programs.

However, we have been actively involved in the Mithril project for several years through a close collaboration with Input Output Global (IOG), which has funded the project to date.

In this context, Teragone has contributed to the development, maintenance, and evolution of Mithril, gaining strong technical expertise and operational experience while delivering work aligned with the broader Cardano ecosystem.

This proposal represents a transition from IOG-funded development to a community-governed funding model via Intersect, ensuring continuity and long-term sustainability of the Mithril project.

### Budget Summary

| Work Package | Total (ADA) |
|---|---|
| Mithril Protocol Continuous Development | 3,699,440 |
| Intersect Budget Administration fee | 110,983 |
| **Total** | **3,810,423** |
...
* [Project Proposal via Intersect Budget Process Hydra Voting](https://hydra-voting.intersectmbo.org/votes/cardano-budget-2026/69f3529e1e63d3708e0dadb6)
