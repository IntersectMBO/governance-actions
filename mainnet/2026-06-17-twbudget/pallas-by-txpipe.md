...
This Treasury Withdrawal funds Pallas by TxPipe: Maintaining Cardano's Core Rust Libraries, Year 2.
...
- And as an important addition to the maintenance scope, we'll focus on upgrading Pallas compatibility with AI-driven development workflows by providing AI-friendly documentation and integration resources.

## Rationale

### Strategic Pillar Alignment

Pallas aligns to Pillar 2 through focus area A.3 (Developer Experience), specifically the open-source incentives area, which calls for incentivizing the maintenance of core Cardano SDKs, frameworks, and infrastructure in line with open-source best practices.

Pallas is exactly this kind of infrastructure. It provides the foundational Rust primitives that projects like Aiken, Dolos, Lucid, Oura, Mithril, Amaru, UTxO-RPC and many others rely on to handle low-level protocol details, allowing them to focus on higher-level functionality rather than re-implementing blockchain primitives themselves. Maintaining Pallas ensures the continued reliability and performance of a key shared resource in the Cardano developer ecosystem.
...
|---|---|
| WP1 - Pallas Maintenance and Enhancement | 525,000 |
...
* [Project Proposal via Intersect Budget Process Hydra Voting](https://hydra-voting.intersectmbo.org/votes/cardano-budget-2026/69f8c6dec9c351b28aa8d7b8)
