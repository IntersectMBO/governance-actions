## Title
Withdraw 540,750 ada for Dolos by TxPipe administered by Intersect
...
- And as an important addition to the maintenance scope, we'll focus on upgrading Dolos compatibility with AI-driven development workflows by providing AI-friendly documentation and integration resources.

## Rationale

### Strategic Pillar Alignment

Dolos aligns to Pillar 2 through focus area A.3 (Developer Experience), specifically the open-source incentives area, which calls for incentivizing the maintenance of core Cardano SDKs, frameworks, and infrastructure in line with open-source best practices.

Dolos is a lightweight Cardano data node that provides developers and infrastructure operators with resource-efficient access to chain data through multiple API protocols (REST, gRPC, JSON-RPC, Ouroboros Node-to-Client). Maintaining Dolos ensures the continued availability of an open-source alternative for querying Cardano chain data without running a full node, while keeping it reliable and performant as adoption grows across the developer ecosystem.
...
|---|---|
| WP1 - Dolos Maintenance and Enhancement | 525,000 |
...
* [Project Proposal via Intersect Budget Process Hydra Voting](https://hydra-voting.intersectmbo.org/votes/cardano-budget-2026/69f9ca0e4b815ecdc8d91a17)
